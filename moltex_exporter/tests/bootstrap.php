...
require_once MOLTEX_PLUGIN_DIR . '/includes/class-plugin-signature-registry.php';
...
require_once MOLTEX_PLUGIN_DIR . '/includes/scanners/class-legacy-evidence-scanner.php';
